...
export const Discount = (): JSX.Element => {
	...
	const buttonPrev = React.useRef(null),
		buttonNext = React.useRef(null)
			...
			<div className="container">
				<div className={styles.discountBody}>
					...
					<div className={styles.slider}>
						<button ref={buttonPrev} className={`${styles.navigationButton} ${styles.buttonPrev}`} onClick={() => buttonPrev}>
						...
						<button ref={buttonNext} className={`${styles.navigationButton} ${styles.buttonNext}`}>
							<svg width="27" height="16" viewBox="0 0 27 16" fill="none" xmlns="http://www.w3.org/2000/svg">
