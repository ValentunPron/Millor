...
import { fetchAuthMe } from '../../redux/action/auth';;

export const Header = ({ headerActive = false }: any): JSX.Element => {
	...
	const { authMe, totalCount } = useSelector((state: any) => {
		return {
			authMe: state.auth.user,
					...
					<div className={styles.headerBody}>
						...
						<nav className={visibleLinks ? styles.navLinksActive : styles.navLinks}>
							...
							<ul className={styles.linksList}>
								<li className='link'><HashLink className='catalogLink' smooth to="/#catalog">Каталог товарів</HashLink></li>
									...
									<li className={styles.actionItem}>
										<Link to='/cart'>
											<button className={styles.cart}>
												...
												<div className={`${styles.cartCount} ${totalCount > 0 ? styles.active : ''}`}>{totalCount}</div>
											</button>
										</Link>
									</li>
									<li className={styles.actionItem}>
							...
							<div className={styles.burgerInfo}>
								<div className={styles.info}>
									...
									<div className={styles.linksSocial}>
										...
										<a href="https://www.instagram.com/valentunpron/">
